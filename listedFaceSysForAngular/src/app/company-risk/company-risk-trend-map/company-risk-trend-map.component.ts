...
@Component({
  selector: 'app-company-risk-trend-map',
  templateUrl: './company-risk-trend-map.component.html',
  styleUrls: ['./company-risk-trend-map.component.css']
})
export class CompanyRiskTrendMapComponent implements OnInit {
  ...
  showChart(){
    ...
    this.companyRiskApiService.getCompanyRiskNewsEvent(body).subscribe(geoJson => {
      if(geoJson.code == '0'){
